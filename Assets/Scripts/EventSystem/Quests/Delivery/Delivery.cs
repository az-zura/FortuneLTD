...
public class Delivery : SequentialEvent
{
    ...
    // for small dialogues
    public Speaker rndNeighbour1 = new Speaker(new string[][]{new []{
    ...
    public Speaker rndColleague2 = new Speaker(new string[][]{new []{
    ...
    public Speaker rndColleague3 = new Speaker(new string[][]{new []{
    ...
    public Speaker karl = new Speaker(new string[][]{new []{
    ...
    public Speaker karen = new Speaker(new string[][]{new []{
    ...
    public Speaker onStreet1 = new Speaker(new string[][]{new []{
    ...
    public Speaker onStreet2 = new Speaker(new string[][]{new []{
    ...
    public Speaker onStreet3 = new Speaker(new string[][]{new []{
    ...
    public Speaker onStreet4 = new Speaker(new string[][]{new []{
