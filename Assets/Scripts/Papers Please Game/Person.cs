...
public class Person
{
    ...
    {
        keinAbschluss, hauptschule, gymnasium, ausbildung, studium
    }
    ...
    public static List<Person> InstantiatePersons()
    {
        ...
        persons.Add(new Person("Isabel Kelly", "YTP-3294U", 20, 95, Jobs.student, Bildungsstand.gymnasium)); 
        ...
        persons.Add(new Person("Peter Parkson", "ENV-0983G", 62, 69, Jobs.arbeitslos, Bildungsstand.hauptschule)); 
        persons.Add(new Person("Jessica Sarah", "KXM-7717M", 32, 94, Jobs.musiklehrer, Bildungsstand.studium)); 
        persons.Add(new Person("Quintus Batiatus", "JSA-1232M", 18, 76, Jobs.schueler, Bildungsstand.gymnasium)); 
        ...
        persons.Add(new Person("Fred Mars", "TMZ-0874H", 22, 88, Jobs.farmer, Bildungsstand.hauptschule)); 
        persons.Add(new Person("Jackie Goldberg", "LOP-8903W", 19, 70, Jobs.student, Bildungsstand.gymnasium));
        persons.Add(new Person("Jack Russ", "GBD-2103J", 55, 67, Jobs.fliessbandarbeiter, Bildungsstand.hauptschule)); 
        ...
        persons.Add(new Person("Ella Lou", "ITR-9435P", 23, 75, Jobs.student, Bildungsstand.gymnasium)); 
